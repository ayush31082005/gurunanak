        ...
        <div className="container-padded grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {categoryMenu.map((category) => (
            <Link
              key={category.slug}
              to={
                category.slug === "health-resource-center"
                  ? "/health-resource-center"
                  : category.slug === "hair-care"
                    ? "/hair-care"
                    : category.slug === "fitness-health"
                      ? "/fitness-health"
                      : category.slug === "sexual-wellness"
                        ? "/sexual-wellness"
                        : category.slug === "vitamins-nutrition"
                          ? "/vitamins-nutrition"
                          : category.slug === "supports-braces"
                            ? "/supports-braces"
                            : category.slug === "immunity-boosters"
                              ? "/immunity-boosters"
                              : category.slug === "homeopathy"
                                ? "/homeopathy"
