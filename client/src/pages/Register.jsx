...
const mrRegisterSlides = [
  {
    ...
    title: "Join As MR",
    description:
      "Create your MR account and manage product activity, order handling and dashboard access easily.",
    accent: "text-orange-500",
    bg: "bg-orange-50",
  },
  {
    ...
    description:
      "Get a dedicated panel for MR work, product visibility, order tracking and earnings overview.",
    accent: "text-cyan-600",
    bg: "bg-cyan-50",
  },
  {
    ...
    title: "Manage Faster",
    description:
      "Use your MR account to stay updated with assigned products and workflow information.",
    accent: "text-emerald-600",
    bg: "bg-emerald-50",
  },
  {
    icon: ShieldCheck,
    title: "Safe MR Registration",
    description:
      "Register securely with OTP verification and continue to your MR dashboard after signup.",
    accent: "text-violet-600",
    bg: "bg-violet-50",
  },
  {
    icon: Mail,
    title: "Quick MR OTP Signup",
    description:
      "Create your MR account quickly using email and OTP verification.",
    accent: "text-rose-500",
    bg: "bg-rose-50",
  },
];
...
const Register = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      setMessage(
        res.data.message ||
        `${registerType === "mr" ? "MR register" : "Register"
      ...
      if (msg.toLowerCase().includes("already registered")) {
        setTimeout(() => {
          navigate(registerType === "mr" ? "/mr-login" : "/login");
        }, 1200);
      }
    } finally {
      setLoading(false);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 px-4">
          <div className="w-full max-w-md rounded-[28px] bg-white p-6 text-center shadow-[0_20px_60px_rgba(15,23,42,0.22)] sm:p-8">
            ...
            <h3 className="mt-5 text-2xl font-bold text-slate-900">
              {registerType === "mr"
                ? "MR Registration Successful"
                : "Registration Successful"}
            </h3>

            <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
              {registerType === "mr"
                ? "Your MR account has been created successfully. Press OK to continue."
                ...
                <div className="w-full max-w-md">
                  <div className="text-center lg:text-left">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-500">
                      {registerType === "mr"
                        ? "Please enter your details to create your MR account."
                  ...
                  <div className="mt-4 grid grid-cols-2 rounded-2xl bg-slate-100 p-1.5">
                    <button
                      ...
                      className={`rounded-xl px-4 py-3 text-sm font-semibold transition ${registerType === "user"
                    ...
                    <button
                      ...
                      className={`rounded-xl px-4 py-3 text-sm font-semibold transition ${registerType === "mr"
                          ? "bg-white text-slate-900 shadow"
                          : "text-slate-500"
                        }`}
                    >
                  ...
                  <p className="mt-5 text-center text-sm text-slate-500">
                    Already registered?{" "}
                    <Link
                      to={registerType === "mr" ? "/mr-login" : "/login"}
                      className="font-semibold text-[#87CEEB] hover:underline"
                    >
                      {registerType === "mr" ? "MR Login" : "Login"}
                    </Link>
                  </p>
