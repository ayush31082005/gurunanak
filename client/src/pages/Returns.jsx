                                ...
                                <div className="grid gap-5 rounded-none border border-slate-200 bg-white p-5 sm:grid-cols-2">
                                                ...
                                                <div className="space-y-3">
                                                    {selectedOrder.items.map((item, index) => (
                                                        <div
                                                            ...
                                                            className="flex flex-col gap-1 border-b border-slate-200 pb-3 last:border-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between"
                                                        >
                                                            <div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            readOnly
                                            value={selectedOrder ? formatPrice(getRefundableAmount(selectedOrder)) : ""}
